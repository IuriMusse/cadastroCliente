object frmViaCliente: TfrmViaCliente
  Left = 0
  Top = 0
  ...
  object pblCadastro: TPanel
    ...
    ParentFont = False
    TabOrder = 0
    object gbDadosdoCadastro: TGroupBox
      Left = 8
      Top = 20
      Width = 777
      Height = 205
    ...
    object gbEndereco: TGroupBox
      ...
      object edtConsultarCEP: TEdit
        ...
        OnKeyDown = edtConsultarCEPKeyDown
      end
      object edtCEP: TEdit
        Left = 16
        Top = 86
